    ...
    return (
        ...
        >
            ...
            {!loadingQuizzes && filteredQuizzes.map((quiz) => {
                ...
                return (
                    <View key={quiz.id} style={[styles.quizRow, { backgroundColor: theme.surfaceLight, borderColor: theme.border }]}>
                        ...
                        <View style={styles.quizActions}>
                            ...
                            >
                                {startingId === quiz.id ? (
                                    ...
                                    <Ionicons name={showStart ? "play" : "bar-chart-outline"} size={16} color={theme.textInverse} />
                                )}
